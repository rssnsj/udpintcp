...
{
	printf("Usage:\n");
	printf(" %s udp_listen_addr tcp_server_addr [-d]     tunnel from client to server side\n", argv[0]);
	printf(" %s udp_remote_addr tcp_server_addr -r [-d]  tunnel from server to client side\n", argv[0]);
}
